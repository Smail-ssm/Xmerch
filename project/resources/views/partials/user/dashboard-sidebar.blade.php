  ...
  <div class="dashbaord-sidebar-close d-xl-none">
    ...
    <div class="widget border-0 py-0 widget_categories">
        ...
        <ul>
            ...
            <li class=""><a class="" href="{{ route('vendor.dashboard') }}">{{ __('Designer Dashboard') }}</a></li>
            @endif
            ...
            <li class=""><a class="{{ Request::url() == route('user-favorites') ? 'active':'' }}" href="{{route('user-favorites')}}">{{ __('Favourite Designers') }}</a></li>
            ...
            <div class="row mt-4">
              <div class="col-lg-12 text-center">
                <a href="{{ route('user-package') }}" class="mybtn1 lg">
                  <i class="fas fa-palette"></i> {{ Auth::user()->is_vendor == 1 ? __('Designer Studio') : (Auth::user()->is_vendor == 0 ? __('Become a Designer') : __('Designer Plans')) }}
                </a>
              </div>
            </div>
          @endif
