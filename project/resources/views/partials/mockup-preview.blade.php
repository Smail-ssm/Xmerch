{{-- Advanced Mockup Preview Component for POD Design Preview v2.0 --}}
<div class="mockup-preview-wrapper" style="margin-top: 20px; padding: 20px; background: linear-gradient(135deg, #f8f9fa, #e9ecef); border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.1);">
    <h4 class="heading" style="margin-bottom: 15px; color: #333;">
        <i class="fas fa-eye"></i> {{ __('Preview on Product') }}
    </h4>
    ...
    <div class="row mb-3">
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
                <label><i class="fas fa-tshirt"></i> {{ __('Product Template') }}</label>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
                <label><i class="fas fa-sync-alt"></i> {{ __('Rotation') }}: <span id="rotation-value">0</span>°</label>
                <input type="range" id="mockup-rotation" min="-180" max="180" value="0" class="form-control-range">
            </div>
        </div>
        <div class="col-lg-4 col-md-6">
            <div class="form-group">
                <label><i class="fas fa-expand-arrows-alt"></i> {{ __('Scale') }}: <span id="scale-value">1.0</span>x</label>
    ...
    <div class="text-overlay-section" style="background: #fff; padding: 15px; border-radius: 8px; margin-bottom: 15px;">
        <h5 style="margin-bottom: 15px;"><i class="fas fa-font"></i> {{ __('Add Text to Design') }}</h5>
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
                    <label>{{ __('Text') }}</label>
                    <input type="text" id="mockup-text-input" class="form-control" placeholder="{{ __('Enter your text...') }}">
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="form-group">
                    ...
                    <button type="button" id="mockup-add-text" class="btn btn-primary btn-block">
                        <i class="fas fa-plus"></i> {{ __('Add Text') }}
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="mockup-actions" style="text-align: center;">
        <button type="button" id="mockup-reset" class="btn btn-secondary">
            <i class="fas fa-undo"></i> {{ __('Reset Position') }}
        </button>
        <small class="d-block mt-2 text-muted">
            <i class="fas fa-info-circle"></i> {{ __('Drag design to move • Drag corners to resize • Drag orange handle to rotate') }}
        </small>
    </div>
</div>
