    ...
    <li>
        <a href="#income" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-file-invoice-dollar"></i>{{ __('Revenue Reports') }}</a>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="menu2" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-mockup-index') }}"><span>{{ __('Mockup Templates') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-pod-pricing-index') }}"><span>{{ __('POD Pricing') }}</span></a>
            </li>
        </ul>
    </li>
