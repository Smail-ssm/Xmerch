{{-- Quality-Based Pricing Calculator Section --}}
		...
		<div class="product-description">
			<div class="body-area" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #fff; padding: 25px; border-radius: 12px;">
				<h4 class="heading" style="color: #fff; border-bottom: 2px solid rgba(255,255,255,0.3); padding-bottom: 15px; margin-bottom: 20px;">
					<i class="fas fa-calculator"></i> {{ __('Quality-Based Pricing') }}
				</h4>
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-print"></i> {{ __('Print Quality') }}
							</label>
					...
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-tshirt"></i> {{ __('Clothing Quality') }}
							</label>
					...
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-boxes"></i> {{ __('Production Speed') }}
							</label>
				...
				<div class="row" style="margin-bottom: 20px;">
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-tag"></i> {{ __('Tag Options') }}
							</label>
					...
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-shield-alt"></i> {{ __('Packaging') }}
							</label>
					...
					<div class="col-lg-4 col-md-6">
						<div style="background: rgba(255,255,255,0.1); padding: 15px; border-radius: 8px; backdrop-filter: blur(10px);">
							<label style="display: block; margin-bottom: 10px; font-weight: 600;">
								<i class="fas fa-percent"></i> {{ __('Your Profit Margin') }} %
							</label>
				...
				{{-- Hidden input to store final price --}}
