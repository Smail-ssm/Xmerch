...
<head>
    ...
    <!-- Google Font -->
    @if(isset($active_theme) && isset($active_theme->font_value))
        <link href="https://fonts.googleapis.com/css?family={{ $active_theme->font_value }}:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
    @elseif ($default_font->font_value)
    ...
    <style>
        :root {
            ...
            @if(isset($active_theme))
                @if(isset($active_theme->primary_color)) --theme-primary: {{ $active_theme->primary_color }}; @endif
                @if(isset($active_theme->bg_color)) --theme-bg: {{ $active_theme->bg_color }}; @endif
                @if(isset($active_theme->font_family)) --theme-font: {!! $active_theme->font_family !!}; @endif
            @else
                --theme-primary: {{ $gs->colors }};
            @endif
        }
        ...
        @if(isset($active_theme))
            @if(isset($active_theme->font_family))
            body { font-family: var(--theme-font) !important; }
            @endif
            
            @if(isset($active_theme->bg_color))
            body { background-color: var(--theme-bg) !important; }
            @endif

            @if(isset($active_theme->global_css)) {!! $active_theme->global_css !!} @endif
            @if(isset($active_theme->header_css)) {!! $active_theme->header_css !!} @endif
            @if(isset($active_theme->product_card_css)) {!! $active_theme->product_card_css !!} @endif
            @if(isset($active_theme->banner_css)) {!! $active_theme->banner_css !!} @endif
            @if(isset($active_theme->footer_css)) {!! $active_theme->footer_css !!} @endif
        @endif
