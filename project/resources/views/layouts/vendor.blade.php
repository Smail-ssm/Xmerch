											...
											<div class="dropdownmenu-wrapper">
													<ul>
														<h5>{{ __('Welcome!') }}</h5>
															...
															<li>
																<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '-', Auth::user()->shop_name)) }}"><i class="fas fa-eye"></i> {{ __('My Design Studio') }}</a>
															</li>
				...
				<div class="wrapper">
					...
					<nav id="sidebar" class="nav-sidebar">
						<ul class="list-unstyled components" id="accordion">
							...
							<li>
								<a target="_blank" href="{{ route('front.vendor',str_replace(' ', '-', Auth::user()->shop_name)) }}" class="wave-effect"><i class="fas fa-eye mr-2"></i> {{ __('My Design Studio') }}</a>
							</li>
							...
							<li>
								<a href="#menu2" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
									<i class="icofont-cart"></i>{{ __('My Designs') }}
								</a>
							...
							<li>
								<a href="{{ route('vendor-prod-import') }}"><i class="fas fa-upload"></i>{{ __('Bulk Design Upload') }}</a>
							</li>
							<li>
							...
							<li>
								<a  href="{{ route('vendor.income') }}" class="wave-effect"><i class="fas fa-eye mr-2"></i> {{ __('My Royalties') }}</a>
							</li>
						</ul>
					</nav>
