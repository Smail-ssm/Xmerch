        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box1">
                    <p>{{ App\Models\User::where( 'created_at', '>', date('Y-m-d H:i:s', strtotime('-30 days')))->get()->count()  }}</p>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box3">
                    <p>{{ App\Models\Order::where('status','=','completed')->where( 'created_at', '>', date('Y-m-d H:i:s', strtotime('-30 days')))->get()->count()  }}</p>
                </div>
                <div class="c-info-box-content">
