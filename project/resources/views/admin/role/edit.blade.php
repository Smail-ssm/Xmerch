              ...
              <div class="add-product-content">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <hr>
                    <h6 class="text-center text-primary">{{ __('POD Manufacturing Permissions') }}</h6>
                    <hr>

                    <div class="row justify-content-center">

                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label">{{ __('Print Production') }} *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="print_production" {{ $data->sectionCheck('print_production') ? 'checked' : '' }}>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label">{{ __('Manufacturing') }} *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="manufacturing" {{ $data->sectionCheck('manufacturing') ? 'checked' : '' }}>
                          <span class="slider round"></span>
                        </label>
                      </div>
                    ...
                    <div class="row justify-content-center">
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label">{{ __('POD Pricing') }} *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="pod_pricing" {{ $data->sectionCheck('pod_pricing') ? 'checked' : '' }}>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label">{{ __('Mockup Templates') }} *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="mockup_templates" {{ $data->sectionCheck('mockup_templates') ? 'checked' : '' }}>
                          <span class="slider round"></span>
                        </label>
                      </div>
