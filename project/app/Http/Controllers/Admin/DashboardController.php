...
class DashboardController extends AdminBaseController
{
    ...
    {
        $activation_data = "<i style='color:darkgreen;' class='icofont-check-circled icofont-4x'></i><br><h3 style='color:darkgreen;'>Your System is Activated!</h3><br> Your License Key:  <b>FREE-TRIAL-MODE</b>";
    ...
    public function movescript(){
        return response()->json(['status' => 'success','message' => 'Feature Disabled.'],200);
    }
