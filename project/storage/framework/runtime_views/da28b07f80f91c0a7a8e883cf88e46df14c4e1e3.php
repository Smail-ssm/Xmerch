                                ...
                                <div class="billing-add-area">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <?php echo e($order->method); ?> <?php echo e(__('Charge ID:')); ?> <p><?php echo e($order->charge_id); ?></p>
                                            <?php endif; ?>
                                            <?php echo e($order->method); ?> <?php echo e(__('Transaction ID:')); ?> <p id="ttn"><?php echo e($order->txnid); ?></p>
                                            <a id="tid" style="cursor: pointer;" class="mybtn2"><?php echo e(__('Edit Transaction ID')); ?></a>

                                            <form id="tform">
                                                <input style="display: none; width: 100%;" type="text" id="tin" placeholder="<?php echo e(__('Enter Transaction ID & Press Enter')); ?>" required="" class="mb-3">
                                                <input type="hidden" id="oid" value="<?php echo e($order->id); ?>">

                                                <button style="display: none; padding: 5px 15px; height: auto; width: auto; line-height: unset;" id="tbtn" type="submit" class="mybtn1"><?php echo e(__('Submit')); ?></button>
                                                <a style="display: none; cursor: pointer;  padding: 5px 15px; height: auto; width: auto; line-height: unset;" id="tc"  class="mybtn1"><?php echo e(__('Cancel')); ?></a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td data-label="<?php echo e(__('Total')); ?>">
                                                    <div>
                                                        <?php echo e(\PriceHelper::showCurrencyPrice(($product['item_price'] ) * $order->currency_value)); ?> <small><?php echo e($product['discount'] == 0 ? '' : '('.$product['discount'].'% '.__('Off').')'); ?></small></small>
                                                    </div>
                                                </td>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\order\details.blade.php ENDPATH**/ ?>