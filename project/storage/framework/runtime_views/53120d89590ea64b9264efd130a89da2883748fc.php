                        ...
                        <tbody>
                           <tr>
                              ...
                              <td class="product-image-title c<?php echo e($product['item']['id']); ?>">
                                 <img class="img-fluid lazy" data-src="<?php echo e($product['item']['thumbnail'] ? asset('assets/images/thumbnails/'.$product['item']['thumbnail']):asset('assets/images/noimage.png')); ?>" alt="Compare product['item']">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\frontend\compare.blade.php ENDPATH**/ ?>