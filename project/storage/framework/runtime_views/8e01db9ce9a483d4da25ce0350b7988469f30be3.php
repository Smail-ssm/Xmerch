                    ...
                    <div class="product-description">
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 d-flex justify-content-between">
                          ...
                          <label class="switch">
                            <input type="checkbox" name="section[]" value="print_production">
                            <span class="slider round"></span>
                          </label>
                        </div>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between">
                          ...
                          <label class="switch">
                            <input type="checkbox" name="section[]" value="manufacturing">
                            <span class="slider round"></span>
                          </label>
                        </div>
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 d-flex justify-content-between">
                          ...
                          <label class="switch">
                            <input type="checkbox" name="section[]" value="pod_pricing">
                            <span class="slider round"></span>
                          </label>
                        </div>
                        ...
                        <div class="col-lg-4 d-flex justify-content-between">
                          ...
                          <label class="switch">
                            <input type="checkbox" name="section[]" value="mockup_templates">
                            <span class="slider round"></span>
                          </label>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\role\create.blade.php ENDPATH**/ ?>