        ...
        <div class="row row-cols-xl-4 row-cols-md-2 row-cols-1">
            ...
            <div class="col">
                <div class="footer-widget category-widget my-5">
                    <h3 class="widget-title mb-4"><?php echo e(__('Product Category')); ?></h3>
                        <ul>
                        <?php $__currentLoopData = DB::table('categories')->where('language_id',Session::has('language')?Session::get('language'):1)->get()->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="footer-widget category-widget my-5">
                    ...
                    <ul>
                        ...
                        <?php if($ps->faq == 1): ?>
                            ...
                            <?php endif; ?>
                            <?php $__currentLoopData = DB::table('pages')->where('language_id',Session::has('language')?Session::get('language'):1)->where('footer','=',1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col">
                <div class="footer-widget widget-nav my-5">
                    ...
                    <ul>
                        <?php $__currentLoopData = DB::table('blogs')->where('language_id',Session::has('language')?Session::get('language'):1)->latest()->limit(3)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $footer_blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <div class="post">
                                <div class="post-img">
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views\partials\global\common-footer.blade.php ENDPATH**/ ?>