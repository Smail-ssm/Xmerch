...
<?php endif; ?>
                            ...
                            <table id="example" class="table">
                                <h4 class="text-center"><?php echo e(__('Ordered Products:')); ?></h4><hr>
                                <thead>
                                <tr>
                                ...
                                <?php $__currentLoopData = $cart['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                            ...
                                            <td>
                                                <?php echo e(\PriceHelper::showOrderCurrencyPrice((($order->pay_amount + $order->wallet_price) * $order->currency_value),$order->currency_sign)); ?> <small><?php echo e($product['discount'] == 0 ? '' : '('.$product['discount'].'% '.__('Off').')'); ?></small>
                                            </td>
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\order\print.blade.php ENDPATH**/ ?>