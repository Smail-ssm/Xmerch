              ...
              <div class="login-form">
                ...
                <form id="passwordform" action="<?php echo e(route('admin.change.password')); ?>" method="POST">
                  ...
                  <div class="form-input">
                    <input type="password" name="cpass" class="Password" placeholder="<?php echo e(__('Current Password')); ?>" required=""><i class="icofont-ui-password"></i>
                  </div>
...
</html><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\changepass.blade.php ENDPATH**/ ?>