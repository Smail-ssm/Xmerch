                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <input name="name" type="text" class="input-field form-control border"
                                          placeholder="<?php echo e(__('User Name')); ?>" required=""
                                 ...
                                 <div class="row mb-4">
                                    <div class="col-lg-6">
                                       <input name="city" type="text" class="input-field form-control border"
                                          placeholder="<?php echo e(__('City')); ?>" value="<?php echo e($user->city); ?>">
                                    </div>
                                    <div class="col-lg-6">
                                 ...
                                 <div class="row mb-4">
                                    ...
                                    <div class="col-lg-6">
                                       <input name="state" type="text" class="input-field form-control border"
                                          placeholder="<?php echo e(__('State')); ?>" value="<?php echo e($user->state); ?>">
                                    </div>
                                 </div>
                                 <div class="row mb-4">
                                    <div class="col-lg-12">
                                       <textarea class="input-field form-control border" name="address" placeholder="<?php echo e(__('Address')); ?>" cols="30" rows="10" required><?php echo e($user->address); ?></textarea>
                                    </div>
                                 </div>
                                      ...
                                      <div class="col-lg-12">
                                          <div class="card border p-3 bg-light">
                                              <div class="d-flex justify-content-between align-items-center text-dark">
                                                  <div>
                                                      <h6 class="mb-1"><?php echo e(__('Theme Preference')); ?></h6>
                                                      <p class="text-muted mb-0 small"><?php echo e(__('Switch between Dark and Light mode')); ?></p>
                                                  </div>
                                                  <div class="theme-chooser-profile" style="cursor: pointer;" id="profile-theme-toggle">
                                                      <button type="button" class="btn btn-outline-primary btn-sm d-flex align-items-center px-3">
                                                          ...
                                                          <span><?php echo e(__('Toggle Theme')); ?></span>
                                                      </button>
                                                  </div>
                                              </div>
                                          </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\profile.blade.php ENDPATH**/ ?>