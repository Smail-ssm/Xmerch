              ...
              <div class="add-product-content">
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <hr>
                    <h6 class="text-center text-primary"><?php echo e(__('POD Manufacturing Permissions')); ?></h6>
                    <hr>

                    <div class="row justify-content-center">

                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label"><?php echo e(__('Print Production')); ?> *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="print_production" <?php echo e($data->sectionCheck('print_production') ? 'checked' : ''); ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label"><?php echo e(__('Manufacturing')); ?> *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="manufacturing" <?php echo e($data->sectionCheck('manufacturing') ? 'checked' : ''); ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                    ...
                    <div class="row justify-content-center">
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label"><?php echo e(__('POD Pricing')); ?> *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="pod_pricing" <?php echo e($data->sectionCheck('pod_pricing') ? 'checked' : ''); ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
                      ...
                      <div class="col-lg-4 d-flex justify-content-between">
                        <label class="control-label"><?php echo e(__('Mockup Templates')); ?> *</label>
                        <label class="switch">
                          <input type="checkbox" name="section[]" value="mockup_templates" <?php echo e($data->sectionCheck('mockup_templates') ? 'checked' : ''); ?>>
                          <span class="slider round"></span>
                        </label>
                      </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\role\edit.blade.php ENDPATH**/ ?>