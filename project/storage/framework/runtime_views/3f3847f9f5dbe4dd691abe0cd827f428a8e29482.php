...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading"><?php echo e(__('Edit Pricing Option')); ?>
            ...
            <div class="col-lg-8">
                <div class="product-description">
                    <div class="body-area">
                        ...
                        <form action="<?php echo e(route('admin-pod-pricing-update', $option->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <select name="category" class="form-control" required>
                                        ...
                                        <option value="<?php echo e($key); ?>" <?php echo e($option->category == $key ? 'selected' : ''); ?>>
                                            <?php echo e($name); ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" name="sort_order" class="form-control" 
                                           value="<?php echo e($option->sort_order); ?>">
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input type="number" name="price" class="form-control" required
                                           step="0.01" min="0" value="<?php echo e($option->price); ?>">
                                </div>
                                <div class="col-lg-6">
                                    <label class="form-label"><?php echo e(__('Status')); ?></label>
                                    <select name="is_active" class="form-control">
                                        <option value="1" <?php echo e($option->is_active ? 'selected' : ''); ?>>Active</option>
                                        <option value="0" <?php echo e(!$option->is_active ? 'selected' : ''); ?>>Inactive</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <textarea name="description" class="form-control" rows="2"><?php echo e($option->description); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button type="submit" class="mybtn1">
                                        <i class="fas fa-save"></i> <?php echo e(__('Update Option')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\pod-pricing\edit.blade.php ENDPATH**/ ?>