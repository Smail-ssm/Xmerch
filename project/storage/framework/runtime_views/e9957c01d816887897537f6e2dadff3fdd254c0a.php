               ...
               <div class="col-lg-12">
                  <div class="widget border-0 p-40 widget_categories bg-light account-info">
                     <div class="header-area">
                        ...
                        <h4 class="title">
                           <?php echo e(__('Order Number:')); ?> <?php echo e($conv->order_number); ?>

                        </h4>
                        <?php endif; ?>
                        <h4 class="title">
                           <?php echo e(__('Conversation with')); ?> <?php echo e($conv->subject); ?> <a  class="mybtn1" href="<?php echo e(url()->previous()); ?>"> <i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a>
                        </h4>
                     </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\ticket\create.blade.php ENDPATH**/ ?>