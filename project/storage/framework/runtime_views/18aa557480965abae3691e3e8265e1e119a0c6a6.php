															...
															<div class="row">
																...
																<div class="col-lg-12">
																	<div class="checkbox-wrapper">
																		<input type="checkbox" name="is_pod" value="1" class="checkclick" id="is_pod" checked>
																		<label for="is_pod"><?php echo e(__('This is a Print-On-Demand Product')); ?></label>
																	</div>
																</div>
															</div>

															<div class="showbox" id="pod-section" style="display: block;">
																<div class="row">
																	<div class="col-lg-12">
																		<div class="left-area">
																...
																<div class="row">
																	<div class="col-lg-6">
																		...
																		<input type="number" class="input-field" name="production_cap" placeholder="<?php echo e(__('e.g. 50')); ?>" min="1">
																	</div>
																	<div class="col-lg-6">
																		<div class="left-area">
																			<h4 class="heading"><?php echo e(__('Est. Print Time (Minutes)')); ?> *</h4>
																		</div>
																		<input type="number" class="input-field" name="print_time_minutes" placeholder="<?php echo e(__('e.g. 30')); ?>" min="1" value="30">
																	</div>
																</div>
                                                                ...
                                                                <div class="row">
																	<div class="col-lg-12">
                                                                        ...
                                                                        <select name="quality_tier">
                                                                            ...
                                                                            <option value="deluxe"><?php echo e(__('Deluxe')); ?></option>
                                                                        </select>
																	</div>
																</div>
															</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\product\create\physical.blade.php ENDPATH**/ ?>