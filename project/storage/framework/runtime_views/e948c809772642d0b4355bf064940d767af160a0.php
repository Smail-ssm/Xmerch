...
<div class="full-row bg-light overlay-dark py-5" style="background-image: url(<?php echo e($gs->breadcrumb_banner ? asset('assets/images/'.$gs->breadcrumb_banner):asset('assets/images/noimage.png')); ?>); background-position: center center; background-size: cover;">
    <div class="container">
        <div class="row text-center text-white">
            <div class="col-12">
                <h3 class="mb-2 text-white"><?php echo e(__('Vendor Login Page')); ?></h3>
            </div>
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 d-inline-flex bg-transparent p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(__('Vendor Login')); ?></li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-8 col-12 mx-auto">
                                    <div class="sign-in-form border">
                                        <h3><?php echo e(__('Vendor Login')); ?></h3>
                                    ...
                                    <?php endif; ?>
                                        <form class="woocommerce-form-login" id="loginform" action="<?php echo e(route('user.login.submit')); ?>" method="POST">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <p>
                                                    <a href="<?php echo e(route('vendor.register')); ?>"  class="text-secondary"><?php echo e(__("Don't have any account?")); ?></a>
                                                </p>
                                                <p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\frontend\vendor-login.blade.php ENDPATH**/ ?>