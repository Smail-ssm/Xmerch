...
<div class="content-area">
    <div class="mr-breadcrumb">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="heading">
                    <i class="fas fa-exclamation-triangle"></i> <?php echo e(__('Failed Jobs')); ?>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body p-2">
                    ...
                    <a href="<?php echo e(route('admin-printjob-failed')); ?>" class="btn btn-danger btn-sm">
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0"><i class="fas fa-times text-danger"></i> <?php echo e(__('Failed Jobs')); ?> (<?php echo e($jobs->total()); ?>)</h5>
                </div>
                <div class="card-body">
                    <?php if($jobs->count() > 0): ?>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-danger"><?php echo e($job->quantity); ?></span></td>
                                    <td><?php echo e(optional($job->printer)->name ?? __('Unassigned')); ?></td>
                                    <td><?php echo e($job->updated_at->format('M d, H:i')); ?></td>
                                    <td>
                                        <span class="text-danger" title="<?php echo e($job->notes); ?>">
                                            <?php echo e(Str::limit($job->notes, 40) ?? __('No reason provided')); ?>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <button class="btn btn-warning retry-job" data-id="<?php echo e($job->id); ?>" title="<?php echo e(__('Retry')); ?>">
                    ...
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted"><?php echo e(__('No failed jobs - great work!')); ?></p>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.retry-job', function() {
        var id = $(this).data('id');
        if (confirm('<?php echo e(__("Retry this print job?")); ?>')) {
            $.ajax({
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\printjob\failed.blade.php ENDPATH**/ ?>