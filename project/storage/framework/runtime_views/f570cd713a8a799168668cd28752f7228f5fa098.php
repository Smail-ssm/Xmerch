...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Left Side Banner1')); ?> </h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="<?php echo e(route('admin-ps-best-seller')); ?>"><?php echo e(__('Left Side Banner1')); ?> </a>
                        </li>
                      </ul>
                  </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\pagesetting\best_seller.blade.php ENDPATH**/ ?>