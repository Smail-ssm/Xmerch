        ...
        <div class="product type-product">
            <div class="product-wrapper">
                <div class="product-image">
                    <a href="<?php echo e(route('front.product','slug')); ?>" class="woocommerce-LoopProduct-link"><img class="lazy" data-src="<?php echo e($product->thumbnail ? asset('assets/images/thumbnails/'.$product->thumbnail):asset('assets/images/noimage.png')); ?>" alt="Product Image"></a>
                    <div class="hover-area">
                        ...
                        <?php else: ?>
                        <div class="cart-button">
                           <a href="javascript:;" data-href="<?php echo e(route('product.cart.add',$product->id)); ?>" class="add-cart button add_to_cart_button" data-bs-toggle="tooltip" data-bs-placement="right" title="" data-bs-original-title="<?php echo e(__('Add To Cart')); ?>" aria-label="<?php echo e(__('Add To Cart')); ?>"></a>
                        </div>
                        <div class="closed">
                           <a  class="button add_to_cart_button add-to-cart-quick" href="javascript:;" data-bs-toggle="tooltip" data-href="<?php echo e(route('product.cart.quickadd',$product->id)); ?>" data-bs-placement="right" title="<?php echo e(__('Buy Now')); ?>" data-bs-original-title="<?php echo e(__('Buy Now')); ?>"><i class="flaticon-shopping-cart-1 flat-mini mx-auto"></i></a>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php if(Auth::check()): ?>
                        ...
                        <div class="compare-button">
                           <a class="compare button button add_to_cart_button" data-href="<?php echo e(route('product.compare.add',$product->id)); ?>" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="right" title="" data-bs-original-title="Compare" aria-label="Compare"><?php echo e(__('Compare')); ?></a>
                        </div>
                     </div>
                </div>
                    ...
                    <div class="shipping-feed-back">
                        <div class="star-rating">
                            <div class="rating-wrap">
                                <p><i class="fas fa-star"></i><span> <?php echo e(App\Models\Rating::ratings($product->id)); ?> (<?php echo e(App\Models\Rating::ratingCount($product->id)); ?>)</span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views\partials\product\vendor-product-different-view.blade.php ENDPATH**/ ?>