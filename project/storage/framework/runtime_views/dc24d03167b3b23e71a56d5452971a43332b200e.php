                         ...
                         <div class="pro-info">
                              ...
                              <p class="price">
                                  <span class="woocommerce-Price-amount amount mr-4">
                                      <bdi><span class="woocommerce-Price-currencySymbol" id="sizeprice"><?php echo e($productt->showPrice()); ?></span></bdi>
                                  </span>
                                  <del class="ml-3"><small><?php echo e($productt->showPreviousPrice()); ?></small></del>
                                 <span class="on-sale"><span><?php echo e(round((double)$productt->offPercentage() )); ?></span>% Off</span>
    ...
    <?php endif; ?>
                      ...
                      <div class="yith-wcwl-add-to-wishlist wishlist-fragment mt-3">
                          ...
                          <div class="compare-button">
                              <a class="compare button" data-href="<?php echo e(route('product.compare.add',$productt->id)); ?>" href="javascript:;" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Compare" aria-label="Compare"><?php echo e(__('Compare')); ?></a>
                          </div>
    ...
    <?php endif; ?>
          ...
          <div class="col-lg-3 col-md-4">
             <div class="pro-details-sidebar-item mb-4">
                ...
                <h3><?php echo e(App\Models\Product::where('user_id','=',$productt->user_id)->count()); ?></h3>
                <?php else: ?>
                <h3><?php echo e(App\Models\Product::where('user_id','=',0)->count()); ?></h3>
                <?php endif; ?>
...
<br>
            <?php if($productt->user_id != 0): ?>
              <?php if(Auth::check()): ?>
                  <?php if(Auth::user()->favorites()->where('vendor_id','=',$productt->user_id)->exists()): ?>
              ...
              <div class="contact-form">
                <form id="emailreply">
                  ...
                  <ul>
                    ...
                    <li>
                      <input type="email" class="form-control border mb-1" id="eml" name="email" placeholder="<?php echo e(__('Email *')); ?>" required="">
                    </li>
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views\partials\product-details\top.blade.php ENDPATH**/ ?>