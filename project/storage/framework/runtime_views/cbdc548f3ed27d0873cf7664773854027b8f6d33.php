       ...
       <div class="row align-items-center">
          <div class="col-lg-4 sm-mx-none">
             <div class="d-flex align-items-center text-general">
                ...
                <span class=""> <?php echo e($ps->phone); ?></span>
             </div>
          </div>
          <div class="col-lg-8 ">
             <ul class="top-links text-general ms-auto d-flex justify-content-end align-items-center mb-0">
                <li class="my-account-dropdown d-flex align-items-center">
                ...
                <li class="my-account-dropdown d-flex align-items-center">
                   <div class="currency-selector nice-select">
                      <span class=""><?php echo e(Session::has('currency') ? DB::table('currencies')->where('id','=',Session::get('currency'))->first()->sign   : DB::table('currencies')->where('is_default','=',1)->first()->sign); ?></span>
                ...
                <li class="my-account-dropdown d-flex align-items-center">
                    <div class="align-items-center text-general sell px-3">
                       <?php if(Auth::check()): ?>
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views\partials\global\top-header.blade.php ENDPATH**/ ?>