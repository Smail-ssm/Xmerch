										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="<?php echo e(route('admin-user-deposit-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
                                                        ...
                                                        <div class="col-lg-7">
                                                                <h6 class="heading"><?php echo e($sign->sign); ?><?php echo e($data->balance); ?> </h6>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\user\deposit.blade.php ENDPATH**/ ?>