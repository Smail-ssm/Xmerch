                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="<?php echo e(route('admin-coupon-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select  name="coupon_type" required="" id="select_type_coupon">
                                  ...
                                  <option value="category" <?php echo e($data->coupon_type == 'category' ? 'selected' : ''); ?> ><?php echo e(__('Category')); ?></option>
                                  <option value="sub_category" <?php echo e($data->coupon_type == 'sub_category' ? 'selected' : ''); ?>><?php echo e(__('Sub Category')); ?></option>
                                  <option value="child_category" <?php echo e($data->coupon_type == 'child_category' ? 'selected' : ''); ?>><?php echo e(__('Child Category')); ?></option>
                              </select>
                          </div>
                        </div>

                        <div class="row <?php echo e($data->category ? '' :'d-none'); ?>" id="category">
                          <div class="col-lg-4">
                            <div class="left-area">
                              ...
                              <select  name="category">
                                  <option value=""><?php echo e(__('Select Category')); ?></option>
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($cat->id); ?>" <?php echo e($data->category == $cat->id ? 'selected':''); ?> ><?php echo e($cat->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                          </div>
                        </div>

                        <div class="row <?php echo e($data->sub_category ? '' :'d-none'); ?>" id="sub_category">
                          <div class="col-lg-4">
                            <div class="left-area">
                              ...
                              <select  name="sub_category" >
                                  <option value=""><?php echo e(__('Select Subcategory')); ?></option>
                                    <?php $__currentLoopData = $sub_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($scat->id); ?>" <?php echo e($data->sub_category == $scat->id ? 'selected':''); ?>><?php echo e($scat->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                          </div>
                        </div>

                        <div class="row <?php echo e($data->child_category ? '' :'d-none'); ?>" id="child_category">
                          <div class="col-lg-4">
                            <div class="left-area">
                              ...
                              <select  name="child_category" >
                                  <option value=""><?php echo e(__('Select Child Category')); ?></option>
                                    <?php $__currentLoopData = $child_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ccat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <option value="<?php echo e($ccat->id); ?>" <?php echo e($data->child_category == $ccat->id ? 'selected':''); ?>><?php echo e($ccat->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select id="times" required="">
                                <option value="0" <?php echo e($data->times == null ? "selected":""); ?>><?php echo e(__('Unlimited')); ?></option>
                                <option value="1" <?php echo e($data->times != null ? "selected":""); ?>><?php echo e(__('Limited')); ?></option>
                              </select>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="start_date" autocomplete="off" id="from" placeholder="<?php echo e(__('Select a date')); ?>" required="" value="<?php echo e($data->start_date); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="end_date" id="to" autocomplete="off" placeholder="<?php echo e(__('Select a date')); ?>" required="" value="<?php echo e($data->end_date); ?>">
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\coupon\edit.blade.php ENDPATH**/ ?>