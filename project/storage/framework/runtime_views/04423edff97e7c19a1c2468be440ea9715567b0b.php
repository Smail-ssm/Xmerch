        ...
        <div class="row align-items-center">
            <div class="col-xl-5 col-md-8">
                <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover nav-line-active main-nav-shell">
                    <a class="navbar-brand header-brand" href="<?php echo e(route('front.index')); ?>">
            ...
            <div class="col-xl-7 col-md-4">
                <div class="margin-right-1 d-flex align-items-center justify-content-end h-100 header-right-cluster">
                    ...
                    <div class="product-search-one flex-grow-1 global-search touch-screen-view top-search-wrap">
                        <form id="searchForm" class="search-form form-inline search-pill-shape js-search-form" action="<?php echo e(route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')])); ?>" method="GET">
                        ...
                        <?php if($gs->reg_vendor == 1): ?>
                           <div class="sell-btn-wrapper d-flex align-items-center">
                              <?php if(Auth::check()): ?>
                                 ...
                                 <a href="<?php echo e(route('vendor.dashboard')); ?>" class="btn btn-sm rounded-pill px-3 py-1 font-12 fw-bold top-sell-btn"> <?php echo e(__('Sell')); ?></a>
                                 <?php else: ?>
                                 <a href="<?php echo e(route('user-package')); ?>" class="btn btn-sm rounded-pill px-3 py-1 font-12 fw-bold top-sell-btn"> <?php echo e(__('Sell')); ?></a>
                                 <?php endif; ?>
                              <?php else: ?>
                                 <a href="<?php echo e(route('vendor.login')); ?>" class="btn btn-sm rounded-pill px-3 py-1 font-12 fw-bold top-sell-btn"> <?php echo e(__('Sell')); ?></a>
                              <?php endif; ?>
                           </div>
                        <?php endif; ?>
		...
		<div class="row align-items-center">
			...
			<div class="col-xxl-7 col-xl-6 col-lg-6 col-12 order-lg-2">
                <div class="product-search-one">
                    <form id="searchForm2" class="search-form form-inline search-pill-shape js-search-form" action="<?php echo e(route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')])); ?>" method="GET">
