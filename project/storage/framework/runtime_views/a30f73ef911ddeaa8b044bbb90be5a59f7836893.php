...
(function($) {
    ...
    var table = $('#geniustable').DataTable({
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          ...
          '<i class="fas fa-plus"> <span class="remove-mobile"><?php echo e(__("Add New")); ?><span>'+
          '</a>'+
          '</div>');
      });                     
...
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\subscription\index.blade.php ENDPATH**/ ?>