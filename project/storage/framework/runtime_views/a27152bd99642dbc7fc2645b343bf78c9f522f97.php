                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="<?php echo e(route('admin-cat-update',$data->id)); ?>" method="POST" enctype="multipart/form-data">
													...
													<div class="col-lg-7">
														<select name="language_id" required="">
															  <?php $__currentLoopData = DB::table('languages')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ldata): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<option value="<?php echo e($ldata->id); ?>" <?php echo e($ldata->id == $data->language_id ? 'selected' : ''); ?>><?php echo e($ldata->language); ?></option>
                                ...
                                <div id="image-preview" class="img-preview" style="background: url(<?php echo e($data->photo ? asset('assets/images/categories/'.$data->photo):asset('assets/images/noimage.png')); ?>);">
                                    ...
                                    <input type="file" name="photo" class="img-upload" id="image-upload">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading"><?php echo e(__('Current Banner')); ?>*</h4>
														</div>
													</div>
                          <div class="col-lg-7">
                        ...
                        <?php $theme = json_decode($data->theme_config, true); ?>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="color" name="theme_config[primary_color]" class="input-field" style="width: 100px; height: 40px; padding: 5px;" value="<?php echo e($theme['primary_color'] ?? '#000000'); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="color" name="theme_config[bg_color]" class="input-field" style="width: 100px; height: 40px; padding: 5px;" value="<?php echo e($theme['bg_color'] ?? '#ffffff'); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" name="theme_config[font_family]" class="input-field" placeholder="e.g. 'Bangers', cursive" value="<?php echo e($theme['font_family'] ?? ''); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" name="theme_config[font_value]" class="input-field" placeholder="e.g. Bangers" value="<?php echo e($theme['font_value'] ?? ''); ?>">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea name="theme_config[global_css]" class="input-field" placeholder="e.g. body { background: #f0f0f0; }"><?php echo e($theme['global_css'] ?? ''); ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea name="theme_config[header_css]" class="input-field" placeholder="e.g. .navbar { padding: 20px; }"><?php echo e($theme['header_css'] ?? ''); ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea name="theme_config[product_card_css]" class="input-field" placeholder="e.g. .product-item { box-shadow: 10px 10px 0px #000; }"><?php echo e($theme['product_card_css'] ?? ''); ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea name="theme_config[banner_css]" class="input-field" placeholder="e.g. .banner-title { font-size: 50px; }"><?php echo e($theme['banner_css'] ?? ''); ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <textarea name="theme_config[footer_css]" class="input-field" placeholder="e.g. .footer { border-top: 5px solid red; }"><?php echo e($theme['footer_css'] ?? ''); ?></textarea>
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\category\edit.blade.php ENDPATH**/ ?>