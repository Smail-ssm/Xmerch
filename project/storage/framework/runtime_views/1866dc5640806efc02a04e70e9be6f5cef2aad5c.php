                        ...
                        <?php $__currentLoopData = $convs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          ...
                          <tr class="conv">
                            ...
                            <td data-label="<?php echo e(__('Actions')); ?>">
                              <div>
                                <a href="<?php echo e(route('user-message',$conv->id)); ?>" class="link view mybtn1"><i class="fa fa-eye"></i></a>
                                <a href="javascript:;" data-bs-toggle="modal" data-bs-target="#confirm-delete" data-href="<?php echo e(route('user-message-delete',$conv->id)); ?>" class="link remove mybtn1"><i class="fa fa-trash"></i></a>
                              </div>
                            </td>
                ...
                <div class="contact-form">
                  <form id="emailreply">
                    ...
                    <ul>
                        ...
                        <div class="msg mb-3">
                            <li>
                                <input type="email" class="input-field form-control border-bottom" id="eml" name="email" placeholder="<?php echo e(__('Email *')); ?>" required="">
                              </li>
                        </div>
                        ...
                        <div class="msg mb-3">
                            <li>
                                <input type="text" class="input-field form-control border-bottom" id="subj" name="subject" placeholder="<?php echo e(__('Subject *')); ?>" required="">
                            </li>
                        </div>

                        <div class="msg mb-5">
                            <li>
                                <textarea class="input-field textarea form-control border-bottom" name="message" id="msg" placeholder="<?php echo e(__('Your Message *')); ?>" required=""></textarea>
                            </li>
                        </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\message\index.blade.php ENDPATH**/ ?>