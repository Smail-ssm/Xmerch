                    ...
                    <div class="col-lg-12">
                        <div class="widget border-0 p-40 widget_categories bg-light account-info">
                            ...
                            <h4 class="widget-title down-line mb-30"><?php echo e(__('Affiliate Program')); ?>
                                ...
                                <a class="mybtn1" href="<?php echo e(route('user-affilate-history')); ?>"> <i class="fas fa-history"></i> <?php echo e(__('Affiliate History')); ?></a>
                            </h4>
                                ...
                                <div class="body">
                                        <div class="edit-info-area-form">
                                                ...
                                                <form>
                                                    ...
                                                    <div class="row pb-5">
                                                        <div class="col-lg-4 text-right pt-2 f-14">
                                                            <label><?php echo e(__('Affiliate Banner *')); ?></label>
                                                            <br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4 text-right pt-2 f-14">
                                                            <label><?php echo e(__('Affiliate Banner HTML Code *')); ?> <a id="affilate_html_click" data-toggle="tooltip" data-placement="top" title="Copy"  href="javascript:;" class="mybtn1 copy border px-3"><i class="fas fa-copy"></i></a></label>
                                                            <br>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\user\affilate\affilate-program.blade.php ENDPATH**/ ?>