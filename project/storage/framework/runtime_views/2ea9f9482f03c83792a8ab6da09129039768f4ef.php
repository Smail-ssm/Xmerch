<?php $__env->startSection('content'); ?>
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Add Slider')); ?> <a class="add-btn" href="<?php echo e(route('admin-sl-index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Back')); ?></a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="<?php echo e(route('admin-sl-create')); ?>"><?php echo e(__('Add Slider')); ?></a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="<?php echo e(route('admin-sl-create')); ?>" method="POST" enctype="multipart/form-data">
                      ...
                      <?php echo $__env->make('alerts.admin.form-both', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="subtitle_text" id="subtitle_text" rows="5"  placeholder="<?php echo e(__('Enter Title Text')); ?>"></textarea>
                                                </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="title_text" id="title_text" rows="5"  placeholder="<?php echo e(__('Enter Title Text')); ?>"></textarea>
                                                </div>
                                              </div>
                                      ...
                                      <div class="panel panel-default slider-panel">
                                              ...
                                              <div class="form-group">
                                                  ...
                                                  <textarea class="form-control" name="details_text" id="details_text" rows="5"  placeholder="<?php echo e(__('Enter Title Text')); ?>"></textarea>
                                                </div>
                                              </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="link" placeholder="<?php echo e(__('Link')); ?>" required="" value="">
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <button class="addProductSubmit-btn" type="submit"><?php echo e(__('Create Slider')); ?></button>
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\slider\create.blade.php ENDPATH**/ ?>