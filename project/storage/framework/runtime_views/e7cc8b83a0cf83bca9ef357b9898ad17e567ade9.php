    ...
    <?php if(Auth::guard('admin')->user()->IsSuper() || Auth::guard('admin')->user()->sectionCheck('manufacturing')): ?>
    <li class="nav-header">
    ...
    <?php if(Auth::guard('admin')->user()->IsSuper() || Auth::guard('admin')->user()->sectionCheck('print_production')): ?>
    <li class="nav-header">
    ...
    <li>
        <a href="#printer" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-print"></i><?php echo e(__('Print Management')); ?>
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="<?php echo e(route('admin-gs-pod-mode')); ?>"><span><?php echo e(__('POD Designer Mode')); ?></span></a>
            </li>
        </ul>
    </li>
