                        ...
                        <div class="row justify-content-center">
                          <div class="col-lg-3">
                            <div class="left-area">
                                ...
                                <small><?php echo e(__('(This background will be displayed if vendor dose not set his / her store background)')); ?></small>
                            </div>
                          </div>
                          <div class="col-lg-6">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\admin\generalsetting\vendor_color.blade.php ENDPATH**/ ?>