            ...
            <div id="sidebar" class="sidebar-blog bg-light p-30">
               ...
               <div class="widget border-0 py-0 widget_categories">
                  ...
                  <ul>
                     ...
                     <li><a class="<?php echo e(isset($bcat) ? ($bcat->id == $cat->id ? 'active' : '') : ''); ?>" href="<?php echo e(route('front.blogcategory',$cat->slug)); ?>"><?php echo e($cat->name); ?>  (<?php echo e($cat->blogs()->count()); ?>) </a></li>
               ...
               <div class="widget border-0 py-0 widget_recent_entries">
                  ...
                  <ul>
                     <?php $__currentLoopData = App\Models\Blog::latest()->where('language_id',$langg->id)->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reblog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <li>
                        <a href="<?php echo e(route('front.blogshow',$reblog->slug)); ?>"><?php echo e(mb_strlen($reblog->title,'UTF-8') > 45 ? mb_substr($reblog->title,0,45,'UTF-8')."..":$reblog->title); ?></a>
            ...
            <div class="single-post">
               <div class="single-post-title">
                  ...
                  <div class="post-meta mb-4">
                     ...
                     <a href="#"><i class="flaticon-calendar flat-mini"></i> <span><?php echo e(date('M d - Y',(strtotime($blog->created_at)))); ?></span></a>
                     <a href="#"><i class="flaticon-like flat-mini"></i> <span><?php echo e($blog->views); ?> <?php echo e(__('View(s)')); ?></span></a>
                     <span><i class="flaticon-document flat-mini text-primary"></i> <a href="#"><span><?php echo e(__('Source')); ?> : </span></a><a href="#"><span><?php echo e($blog->source); ?></span></a></span>
                  </div>
               </div>
               <div class="img">
                  <img data-src="<?php echo e(asset('assets/images/blogs/'.$blog->photo)); ?>" class="img-fluid lazy" alt="">
               </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\frontend\blogshow.blade.php ENDPATH**/ ?>