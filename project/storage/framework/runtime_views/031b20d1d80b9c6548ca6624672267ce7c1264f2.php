            ...
            <div class="col-lg-4 md-mb-50">
               <div id="sidebar" class="sidebar-blog bg-light p-30">
                  ...
                  <div class="widget border-0 py-0 widget_recent_entries">
                     ...
                     <ul>
                        <?php $__currentLoopData = App\Models\Blog::latest()->where('language_id',$langg->id)->limit(4)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                  ...
                  <div class="col-md-12">
                     <div class="thumb-blog-horizontal clearfix hover-img-zoom transation mb-30">
                        ...
                        <div class="post-content ps-3">
                           ...
                           <div class="date text-primary font-small text-uppercase"><span><?php echo e(date('M d - Y',(strtotime($blog->created_at)))); ?></span></div>
                        </div>
                     </div>
                  </div>
               </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views\frontend\blog.blade.php ENDPATH**/ ?>