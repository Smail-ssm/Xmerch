								...
								<div class="heading-area">
	                                ...
	                                <div class="action-list">
	                                    <select class="process select1 vdroplinks <?php echo e($gs->reg_vendor == 1 ? 'drop-success' : 'drop-danger'); ?>">
	                                      <option data-val="1" value="<?php echo e(route('admin-gs-status',['reg_vendor',1])); ?>" <?php echo e($gs->reg_vendor == 1 ? 'selected' : ''); ?>><?php echo e(__("Activated")); ?></option>
	                                      <option data-val="0" value="<?php echo e(route('admin-gs-status',['reg_vendor',0])); ?>" <?php echo e($gs->reg_vendor == 0 ? 'selected' : ''); ?>><?php echo e(__("Deactivated")); ?></option>
	                                    </select>
									  </div>
...
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views/admin/vendor/index.blade.php ENDPATH**/ ?>