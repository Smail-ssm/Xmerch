...
<div class="full-row">
   <div class="container">
      <div class="row justify-content-between">
         ...
         <?php if($productt->user_id != 0 && $productt->user->products->count() > 0): ?>
         <div class="col-lg-3">
                    ...
                    <div class="product-style-2 owl-carousel owl-nav-hover-primary nav-top-right single-carousel dot-disable product-list e-bg-white">
                        ...
                        <?php $__currentLoopData = $productt->user->products->take(9)->chunk(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    <div class="on-sale"><span><?php echo e(round((double)App\Models\Product::whereId($prod['id'])->first()->offPercentage())); ?></span><span>% off</span></div>
                                                </div>
         ...
         <div class="col-12">
            <div class="products product-style-1 owl-mx-5">
               <div class="five-carousel owl-carousel nav-top-right e-title-hover-primary e-image-bg-light e-hover-image-zoom e-info-center">
                  <?php $__currentLoopData = DB::table('products')->where('type',$productt->type)->where('product_type',$productt->product_type)->where('language_id',Session::has('language') ? Session::get('language') : 1)->take(12)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <div class="item">
                     <div class="product type-product">
                        <div class="product-wrapper">
                           <div class="product-image">
                              ...
                              <div class="on-sale">-<?php echo e(round((double)App\Models\Product::find($item->id)->offPercentage())); ?>%</div>
                              <div class="hover-area">
                                 ...
                                 <?php else: ?>
                                 <?php if(App\Models\Product::where('id',$item->id)->first()->emptyStock()): ?>
                                 <div class="closed">
                           ...
                           <div class="product-info">
                              <h3 class="product-title"><a href="<?php echo e(route('front.product', $item->slug)); ?>"><?php echo e(App\Models\Product::find($item->id)->showName()); ?></a></h3>
                              <div class="product-price">
                                 <div class="price">
                                    <ins><?php echo e(App\Models\Product::find($item->id)->showPrice()); ?></ins>
                                    <del><?php echo e(App\Models\Product::find($item->id)->showPreviousPrice()); ?></del>
                                 </div>
                              </div>
                              <div class="shipping-feed-back">
                                 <div class="star-rating">
                                    <div class="rating-wrap">
                                       <p><i class="fas fa-star"></i><span> <?php echo e(App\Models\Rating::ratings($item->id)); ?> (<?php echo e(App\Models\Rating::ratingCount($item->id)); ?>)</span></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views/frontend/product.blade.php ENDPATH**/ ?>