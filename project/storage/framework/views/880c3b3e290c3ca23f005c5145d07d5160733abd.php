												...
												<table id="geniustable" class="table table-hover dt-responsive" cellspacing="0" width="100%">
													<thead>
														<tr>
                                                            ...
                                                            <th width="40%"><?php echo e(__('Header')); ?></th>
...
(function($) {
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="<?php echo e(route('admin-arrival-create')); ?>">'+
          '<i class="fas fa-plus"></i> <?php echo e(__('Add New Arrival')); ?>'+
          '</a>'+
          '</div>');
      });
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views/admin/arrival/index.blade.php ENDPATH**/ ?>