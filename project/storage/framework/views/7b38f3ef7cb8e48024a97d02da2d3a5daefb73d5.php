        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box1">
                    <p><?php echo e(App\Models\User::where( 'created_at', '>', date('Y-m-d H:i:s', strtotime('-30 days')))->get()->count()); ?></p>
                </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card c-info-box-area">
                <div class="c-info-box box3">
                    <p><?php echo e(App\Models\Order::where('status','=','completed')->where( 'created_at', '>', date('Y-m-d H:i:s', strtotime('-30 days')))->get()->count()); ?></p>
                </div>
                <div class="c-info-box-content">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>