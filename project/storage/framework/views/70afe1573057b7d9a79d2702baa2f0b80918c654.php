...
<head>
	...
	<body id="page-top">
		...
		<?php if(Session::has('auto_print_label')): ?>
		<script>
			$(document).ready(function() {
				window.open('<?php echo e(Session::get('auto_print_label')); ?>', '_blank');
			});
		</script>
		<?php endif; ?>
...
<style>
	...
	.nav-sidebar ul li.nav-header i {
		margin-right: 5px;
	}
</style>
...
<?php /**PATH C:\laragon\www\xmerch\project\resources\views/layouts/admin.blade.php ENDPATH**/ ?>