...
<?php if($hasSalesAccess): ?>
    ...
    <?php if($user->sectionCheck('orders')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('earning')): ?>
    <li>
        <a href="#income" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-file-invoice-dollar"></i><?php echo e(__('Total Earning')); ?></a>
    ...
    <?php if($user->sectionCheck('customer_deposits')): ?>
    <li>
...
<?php if($hasInventoryAccess): ?>
    ...
    <?php if($user->sectionCheck('categories')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('products')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('affilate_products')): ?>
    <li>
...
<?php if($user->sectionCheck('print_production')): ?>
    <li class="nav-header">
    ...
    <li>
        <a href="#printer" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-print"></i><?php echo e(__('Printer Dashboard')); ?>
        ...
        <ul class="collapse list-unstyled" id="printer" data-parent="#accordion">
            ...
            <li>
                <a href="<?php echo e(route('admin-printer-queue')); ?>"><span><?php echo e(__('Printing Queue')); ?></span></a>
            </li>
            <li>
            ...
            <li class="nav-header" style="padding: 10px 15px; font-size: 11px; color: #888;">
                <?php echo e(__('Advanced Tracking')); ?>

            </li>
            <li>
                <a href="<?php echo e(route('admin-printjob-index')); ?>"><span><?php echo e(__('Print Jobs (Items)')); ?></span></a>
            </li>
        </ul>
    </li>
<?php endif; ?>
...
<?php if($user->sectionCheck('manufacturing')): ?>
    <li class="nav-header">
        <i class="fas fa-industry"></i> <?php echo e(__('Manufacturing')); ?>

    </li>

    <li>
        <a href="#manufacturing" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-industry"></i><?php echo e(__('Production Management')); ?>

        </a>
        <ul class="collapse list-unstyled" id="manufacturing" data-parent="#accordion">
            <li>
                <a href="<?php echo e(route('admin-manufacturing-dashboard')); ?>"><span><?php echo e(__('Dashboard')); ?></span></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-manufacturing-capacity')); ?>"><span><?php echo e(__('Capacity Planning')); ?></span></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-manufacturing-schedule')); ?>"><span><?php echo e(__('Production Schedule')); ?></span></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-manufacturing-quality')); ?>"><span><?php echo e(__('Quality Control')); ?></span></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-manufacturing-analytics')); ?>"><span><?php echo e(__('Analytics')); ?></span></a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-manufacturing-queue')); ?>"><span><?php echo e(__('Manufacturing Queue')); ?></span></a>
            </li>
        </ul>
    </li>
<?php endif; ?>
...
<?php if($hasCRMAccess): ?>
    ...
    <?php if($user->sectionCheck('customers')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('vendors')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('vendor_subscriptions')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('vendor_verifications')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('vendor_subscription_plans')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('messages')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('product_discussion')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('subscribers')): ?>
    <li>
...
<?php if($hasContentAccess): ?>
    ...
    <?php if($user->sectionCheck('home_page_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('menu_page_settings')): ?>
    <li>
...
<?php if($hasSystemAccess): ?>
    ...
    <?php if($user->sectionCheck('general_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('emails_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('payment_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('social_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('language_settings')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('seo_tools')): ?>
    <li>
    ...
    <?php if($user->sectionCheck('manage_country')): ?>
    <li>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\xmerch\project\resources\views/partials/admin-role/normal.blade.php ENDPATH**/ ?>