    ...
    <div class="row">
        <div class="col-lg-3 col-md-6">
            <div class="stat-card pending" style="position:relative;">
                ...
                <a href="<?php echo e(route('admin-printer-queue')); ?>">View All →</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="stat-card printing" style="position:relative;">
                ...
                <a href="<?php echo e(route('admin-printer-printing')); ?>">View →</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="stat-card printed" style="position:relative;">
                ...
                <a href="<?php echo e(route('admin-printer-ready')); ?>">View →</a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6">
            <div class="stat-card shipped" style="position:relative;">
                ...
                <a href="<?php echo e(route('admin-printer-shipped')); ?>">View All →</a>
            </div>
        </div>
    </div>
                            ...
                            <tbody>
                                ...
                                <tr class="<?php echo e($isEligible ? 'table-success' : ''); ?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('admin-printer-start', $order->id)); ?>" class="action-btn start">
                                            <i class="fas fa-play"></i> Start
                                        </a>
                                        <?php elseif($order->print_status == 'printing'): ?>
                                        <a href="<?php echo e(route('admin-printer-printed', $order->id)); ?>" class="action-btn finish">
