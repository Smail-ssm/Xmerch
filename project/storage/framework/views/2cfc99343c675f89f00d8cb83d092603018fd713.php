            ...
            <form id="geniusform" action="<?php echo e(route('admin-ps-menuupdate')); ?>" method="POST"
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="home"><?php echo e(__('Home')); ?> *</label>
                  <label class="switch">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\xmerch\project\resources\views/admin/pagesetting/menu_links.blade.php ENDPATH**/ ?>