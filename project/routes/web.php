...
/////////////////////////////// ////////////////////////////////////////////
  ...
  //------------ ADMIN MOCKUP TEMPLATES SECTION ------------

  Route::get('/mockup-templates', 'Admin\MockupTemplateController@index')->name('admin-mockup-index');
  Route::get('/mockup-templates/create', 'Admin\MockupTemplateController@create')->name('admin-mockup-create');
  Route::post('/mockup-templates/store', 'Admin\MockupTemplateController@store')->name('admin-mockup-store');
  Route::get('/mockup-templates/edit/{id}', 'Admin\MockupTemplateController@edit')->name('admin-mockup-edit');
  Route::put('/mockup-templates/update/{id}', 'Admin\MockupTemplateController@update')->name('admin-mockup-update');
  Route::get('/mockup-templates/delete/{id}', 'Admin\MockupTemplateController@destroy')->name('admin-mockup-delete');
  Route::get('/mockup-templates/status/{id}', 'Admin\MockupTemplateController@status')->name('admin-mockup-status');
  Route::get('/api/mockup-templates', 'Admin\MockupTemplateController@getTemplatesJson')->name('api-mockup-templates');

  //------------ ADMIN MOCKUP TEMPLATES SECTION ENDS------------

  //------------ ADMIN POD PRICING SECTION ------------

  Route::get('/pod-pricing', 'Admin\PodPricingController@index')->name('admin-pod-pricing-index');
  Route::get('/pod-pricing/create', 'Admin\PodPricingController@create')->name('admin-pod-pricing-create');
  Route::post('/pod-pricing/store', 'Admin\PodPricingController@store')->name('admin-pod-pricing-store');
  Route::get('/pod-pricing/edit/{id}', 'Admin\PodPricingController@edit')->name('admin-pod-pricing-edit');
  Route::put('/pod-pricing/update/{id}', 'Admin\PodPricingController@update')->name('admin-pod-pricing-update');
  Route::get('/pod-pricing/delete/{id}', 'Admin\PodPricingController@destroy')->name('admin-pod-pricing-delete');
  Route::get('/pod-pricing/status/{id}', 'Admin\PodPricingController@status')->name('admin-pod-pricing-status');
  Route::get('/api/pod-pricing', 'Admin\PodPricingController@getOptionsJson')->name('api-pod-pricing');
  ...
  Route::group(['middleware'=>'permissions:print_production'],function(){
    ...
    Route::get('/printer', 'Admin\PrinterController@dashboard')->name('admin-printer-dashboard');
    Route::get('/printer/queue', 'Admin\PrinterController@queue')->name('admin-printer-queue');
    Route::get('/printer/printing', 'Admin\PrinterController@printing')->name('admin-printer-printing');
    ...
    Route::get('/printer/print-file/{id}', 'Admin\PrinterController@printFile')->name('admin-printer-file');
    Route::get('/printer/shipping-label/{id}', 'Admin\PrinterController@shippingLabel')->name('admin-printer-label');
    Route::get('/printer/accounts', 'Admin\PrinterController@accounts')->name('admin-printer-accounts');
